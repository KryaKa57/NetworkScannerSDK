#
#  Be sure to run `pod spec lint NetworkScannerSDK.podspec' to ensure this is a
...
DESC
  ...
  # Or just: spec.author    = "Kryakalka"
  # spec.authors            = { "Kryakalka" => "kuanyshbekovalisher57@gmail.com" }
  # spec.social_media_url   = "https://twitter.com/Kryakalka"
  ...
  spec.source       = { :git => "https://github.com/KryaKa57/NetworkScannerSDK.git", :tag => "1.0.1" }
